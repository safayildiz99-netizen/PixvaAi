...
export default function VideoStudio({ project, onSaved }) {
  ...
  return <section className="video-studio">
    ...
    <div className="merge-panel"><div><h3>Gesamtvideo</h3><p>Alle fertigen Abschnitte in der sichtbaren Reihenfolge verbinden.</p></div><button className="primary-btn" onClick={mergeVideos}><Film size={17}/>MP4 zusammenfügen</button></div>
